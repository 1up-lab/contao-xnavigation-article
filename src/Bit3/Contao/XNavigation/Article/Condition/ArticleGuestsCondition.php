...
/**
 * Class ArticleGuestsCondition
 */
class ArticleGuestsCondition implements ConditionInterface
{
	...
	{
		return $this->acceptedGuestsStatus ? 'article.guestsOnly' : '!article.guestsOnly';
	}
}
